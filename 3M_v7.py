...
def generuj_sp(periods, amplitudeP, frequencyP, noise_levelP):
    ...
    smooth_noise = np.clip(smooth_noise, -0.05 * amplitudeP, None)
...
def run_efficiency_chart():
   ...
   # Dynamiczne tworzenie kolumn efektywności na podstawie słownika
    ...
    # Wykres
    fig_eff1 = px.line(df_3M_eff, x='Time Period', y=eff_columns, width=1000, height=600, color_discrete_sequence=px.colors.sequential.Viridis)
